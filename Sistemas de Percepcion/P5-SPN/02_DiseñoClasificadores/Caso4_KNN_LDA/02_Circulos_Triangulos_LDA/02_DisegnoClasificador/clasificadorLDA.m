%% APLICACION CLASIFICADOR LDA PARA CIRCULOS VS TRIANGULOS
...
load ('../01_SeleccionDescriptores/DatosGenerados/espacio_ccas_circ_tria.mat');
...
title('Frontera Separacion LDA circulos vs triangulos'),
legend(textoLeyenda)
grid on, hold off

% GUARDADO DE INFORMACION
save('./DatosGenerados/LDA_circ_tria.mat','d12','espacioCcas','nombresProblemaOIRed','XoIRed','YoIRed','coef_d12');
